...
# LOCAL PATCH (augenblick): BatchedDatapoint is defined in sam3.model.data_misc; collator
# merely re-exports it. Importing it from there pulled in the whole sam3/train/data/
# subtree (and pycocotools) for a single type annotation, so take it from the source.
