<!-- LOCAL PATCH (augenblick) -->
> **Note — this is a trimmed vendored copy of SAM 3.**
> Only the image-masking inference path is kept, for `augenblick mask sam3`. The training,
> evaluation, video/tracking, multiplex and agent code has been removed, along with
> `examples/`, `scripts/`, `assets/` and `README_TRAIN.md` / `RELEASE_SAM3p1.md`. Links below
> to any of those paths will not resolve — consult
> [upstream](https://github.com/facebookresearch/sam3) instead. See
> `.claude/PLANS/sam3-masking-method.md` §1 for what was removed and why.
